...
//     /**
//      * Le o arquivo original e gera um arquivo DOT para o Graphviz.
//      */
...
//     /**
//      * Constroi o dígrafo eulerizado, exibe tabela de balanceamento e executa Hierholzer.
//      */
...
//         // Mapeamento de indices para nomes (A, B, C...)
...
//         // Tabela de Graus Formatada conforme solicitado
...
//             System.out.println("STATUS: Circuito euleriano encontrado com sucesso.");
...
//             System.out.println("------------------------------------------------");
//             System.out.printf("CUSTO TOTAL (ORIGINAL + REPETICOES): %.2f\n", custoTotal);
//         } else {
//             System.out.println("STATUS: O grafo fornecido nao permite um circuito euleriano.");
//         }
//         System.out.println("================================================");
...
//     /**
//      * Helper para salvar o conteudo no formato DOT do Graphviz.
//      */
...
//         } catch (IOException e) {
//             System.err.println("Erro ao salvar arquivo DOT: " + e.getMessage());
//         }
//     }
// }
